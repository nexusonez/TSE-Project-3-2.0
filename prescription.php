	...
	<div class ="form" method="POST">
		...
		<div class ="divform">
			...
			?>		
					<tbody>
						<tr>
						<td><a download href="files/<?php echo $row["Prescription"]; ?>"><i class="fa fa-download"></i></a><a href ="prescription_edit.php?edit&MemberID=<?php echo $row["MemberID"];?>"><i class="fa fa-edit"></i></a></td>
