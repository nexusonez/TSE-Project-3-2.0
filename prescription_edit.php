...
<body>
	...
	<div><h1>Prescription Review</h1></div>
	
	<div class ="form">
		<div class ="title">
		Review Members prescription
		</div>
...
<?php
		...
		<table>
			...
			<tr>
				<td>Prescription: </td>
				<td><a download href="files/<?php echo $row["Prescription"]; ?>"><i class="fa fa-download" style="margin-left:-110px;"></i></a>    <?php echo $row["Prescription"]; ?></td>
			</tr>
			
			<tr>
				<td><label for="status">Status:</label>
					<select id="status" name="status" style="margin-left:100px;">
	...
	<div>
		<button class="btn1"><a href ="prescription.php">Exit</a></button>
	</div>
	</div>
	</table>
...
if(isset($_POST['submitbtn']))
{
	...
	mysqli_query($connect, "UPDATE member SET Status='$status' WHERE MemberID='$id'");
				
			echo'<script type="text/javascript">
			alert("Prescription Details updated!");
			</script>';
			header( 'refresh:0.5; url=prescription.php' );
}
?>