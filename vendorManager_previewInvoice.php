...
<head>
<meta charset="UTF-8">
<title>VM Preview Invoice</title>
...
<body>
	...
	<div style ="margin-top:110px; margin-left:65px;"><h1>Preview Invoice</h1></div>
    ...
    <button type="button" style ="background-color: #38b6ff; float:right; margin-right:100px;" onclick="window.location.href='vendorManager_home.php';">Go Back <i class="fa-solid fa-arrow-right-from-bracket"></i></button>
