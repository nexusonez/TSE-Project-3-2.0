...
<?php
		...
		<table>
			<tr>
				<td>ID:</td>
				<td><input type="text" name="id" value="<?php echo $row["Code"]; echo $row["DoctorID"];?>"readonly></td>
			</tr>
			...
			<tr>
				<td>Address: </td>
				<td><textarea name ="address" rows="5" col="80" required><?php echo $row["Address"]?></textarea></td>
			</tr>
...
if(isset($_POST['submitbtn']))
{
	$file = $_FILES['img'];
		...
		mysqli_query($connect,"UPDATE doctors SET D_Name='$name', Gender='$gender', Status='$status',
				Email='$email', Hpnum='$hpnum', Password='$password', Address='$address', dp='$fileDestination', description='$description', experience='$experience' WHERE DoctorID='$id'");
